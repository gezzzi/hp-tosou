  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: "お見積り時に提示した金額から、当日に追加料金が発生することはございません。ただし、お見積り時よりも回収品が大幅に増えた場合などは、再度ご相談させていただく場合がございます。"
      },
      {
                ...
                <div key={catIndex}>
                  ...
                  <div className="space-y-4">
                    {category.items.map((item, itemIndex) => (
                      <details 
                        key={itemIndex} 
                        className="group border border-(--border-light) rounded-lg overflow-hidden transition-all duration-300"
                      >
