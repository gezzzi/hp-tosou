                ...
                <form onSubmit={handleSubmit} className="space-y-6 md:text-lg">
                  ...
                  <div>
                    ...
                    <textarea
                      name="お問い合わせ内容"
                      rows={6}
                      className="w-full px-4 py-3 border-2 border-[#9ca3af] rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--primary-green)] focus:border-transparent resize-none bg-white text-base md:text-lg"
