      ...
      <main className="main-content">
        ...
        <section className="py-16 bg-[var(--bg-light)]">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="text-[var(--text-medium)] leading-relaxed mb-10 max-w-2xl mx-auto">
        ...
        <section id="painting" className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-4">
            <h2 className="text-2xl font-bold text-[var(--text-dark)] mb-4 text-center">
              塗装工事
            </h2>
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="max-w-2xl mx-auto">
              <div className="bg-[var(--accent-yellow)]/10 rounded-lg p-8 text-center mb-8 border-2 border-[var(--accent-yellow)]">
                ...
                <p className="text-5xl font-bold text-[var(--text-dark)] mb-2">
